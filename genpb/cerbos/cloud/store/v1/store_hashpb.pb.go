...
func (m *GetCurrentVersionRequest) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_cloud_store_v1_GetCurrentVersionRequest_hashpb_sum(m, hasher, ignore)
	}
}
...
func (m *GetCurrentVersionResponse) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_cloud_store_v1_GetCurrentVersionResponse_hashpb_sum(m, hasher, ignore)
	}
}
...
func (m *ReplaceFilesRequest_Files) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_cloud_store_v1_ReplaceFilesRequest_Files_hashpb_sum(m, hasher, ignore)
	}
}
...
func (m *ErrDetailConditionUnsatisfied) HashPB(hasher hash.Hash, ignore map[string]struct{}) {
	if m != nil {
		cerbos_cloud_store_v1_ErrDetailConditionUnsatisfied_hashpb_sum(m, hasher, ignore)
	}
}
