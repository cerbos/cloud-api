...
var file_cerbos_cloud_store_v1_store_proto_goTypes = []any{
	...
	(*ReplaceFilesResponse)(nil),          // 18: cerbos.cloud.store.v1.ReplaceFilesResponse
	(*StringMatch_InList)(nil),            // 19: cerbos.cloud.store.v1.StringMatch.InList
	(*ChangeDetails_Git)(nil),             // 20: cerbos.cloud.store.v1.ChangeDetails.Git
	(*ChangeDetails_Internal)(nil),        // 21: cerbos.cloud.store.v1.ChangeDetails.Internal
	(*ChangeDetails_Uploader)(nil),        // 22: cerbos.cloud.store.v1.ChangeDetails.Uploader
	nil,                                   // 23: cerbos.cloud.store.v1.ChangeDetails.Internal.MetadataEntry
	nil,                                   // 24: cerbos.cloud.store.v1.ChangeDetails.Uploader.MetadataEntry
	(*ModifyFilesRequest_Condition)(nil),  // 25: cerbos.cloud.store.v1.ModifyFilesRequest.Condition
	(*ReplaceFilesRequest_Condition)(nil), // 26: cerbos.cloud.store.v1.ReplaceFilesRequest.Condition
	(*timestamppb.Timestamp)(nil),         // 27: google.protobuf.Timestamp
	(*structpb.Value)(nil),                // 28: google.protobuf.Value
}
var file_cerbos_cloud_store_v1_store_proto_depIdxs = []int32{
	19, // 0: cerbos.cloud.store.v1.StringMatch.in:type_name -> cerbos.cloud.store.v1.StringMatch.InList
	...
	22, // 4: cerbos.cloud.store.v1.ChangeDetails.uploader:type_name -> cerbos.cloud.store.v1.ChangeDetails.Uploader
	20, // 5: cerbos.cloud.store.v1.ChangeDetails.git:type_name -> cerbos.cloud.store.v1.ChangeDetails.Git
	21, // 6: cerbos.cloud.store.v1.ChangeDetails.internal:type_name -> cerbos.cloud.store.v1.ChangeDetails.Internal
	6,  // 7: cerbos.cloud.store.v1.FileOp.add_or_update:type_name -> cerbos.cloud.store.v1.File
	25, // 8: cerbos.cloud.store.v1.ModifyFilesRequest.condition:type_name -> cerbos.cloud.store.v1.ModifyFilesRequest.Condition
	...
	26, // 12: cerbos.cloud.store.v1.ReplaceFilesRequest.condition:type_name -> cerbos.cloud.store.v1.ReplaceFilesRequest.Condition
	...
	27, // 15: cerbos.cloud.store.v1.ChangeDetails.Git.commit_date:type_name -> google.protobuf.Timestamp
	27, // 16: cerbos.cloud.store.v1.ChangeDetails.Git.author_date:type_name -> google.protobuf.Timestamp
	23, // 17: cerbos.cloud.store.v1.ChangeDetails.Internal.metadata:type_name -> cerbos.cloud.store.v1.ChangeDetails.Internal.MetadataEntry
	24, // 18: cerbos.cloud.store.v1.ChangeDetails.Uploader.metadata:type_name -> cerbos.cloud.store.v1.ChangeDetails.Uploader.MetadataEntry
	28, // 19: cerbos.cloud.store.v1.ChangeDetails.Internal.MetadataEntry.value:type_name -> google.protobuf.Value
	28, // 20: cerbos.cloud.store.v1.ChangeDetails.Uploader.MetadataEntry.value:type_name -> google.protobuf.Value
	...
	18, // 28: cerbos.cloud.store.v1.CerbosStoreService.ReplaceFiles:output_type -> cerbos.cloud.store.v1.ReplaceFilesResponse
