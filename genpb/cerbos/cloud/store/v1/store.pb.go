...
const file_cerbos_cloud_store_v1_store_proto_rawDesc = "" +
	...
	"\x11new_store_version\x18\x01 \x01(\x03R\x0fnewStoreVersion\"\xa7\x04\n" +
	...
	"\tCondition\x12@\n" +
	"\x18store_version_must_equal\x18\x01 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x15storeVersionMustEqual\x1a:\n" +
	"\x05Files\x121\n" +
	"\x05files\x18\x01 \x03(\v2\x1b.cerbos.cloud.store.v1.FileR\x05filesB\x11\n" +
