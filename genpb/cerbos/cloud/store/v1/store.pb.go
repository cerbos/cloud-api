...
const (
	...
	FileKind_FILE_KIND_POLICY      FileKind = 1
	FileKind_FILE_KIND_SCHEMA      FileKind = 2
	FileKind_FILE_KIND_TEST        FileKind = 3
	FileKind_FILE_KIND_TEST_DATA   FileKind = 4
)
...
type FileFilter struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Kinds         []FileKind             `protobuf:"varint,1,rep,packed,name=kinds,proto3,enum=cerbos.cloud.store.v1.FileKind" json:"kinds,omitempty"`
	Path          *StringMatch           `protobuf:"bytes,2,opt,name=path,proto3,oneof" json:"path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FileFilter) GetKinds() []FileKind {
	if x != nil {
		return x.Kinds
	}
	return nil
...
type ListFilesResponse struct {
	...
	Files         []*ListFilesResponse_File `protobuf:"bytes,2,rep,name=files,proto3" json:"files,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type File struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Kind          FileKind               `protobuf:"varint,1,opt,name=kind,proto3,enum=cerbos.cloud.store.v1.FileKind" json:"kind,omitempty"`
...
type GetFilesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StoreVersion  int64                  `protobuf:"varint,1,opt,name=store_version,json=storeVersion,proto3" json:"store_version,omitempty"`
	Files         map[string]*File       `protobuf:"bytes,2,rep,name=files,proto3" json:"files,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListFilesResponse_File struct {
	...
	Kind          FileKind               `protobuf:"varint,2,opt,name=kind,proto3,enum=cerbos.cloud.store.v1.FileKind" json:"kind,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListFilesResponse_File) GetKind() FileKind {
	if x != nil {
		return x.Kind
	}
	return FileKind_FILE_KIND_UNSPECIFIED
...
var file_cerbos_cloud_store_v1_store_proto_rawDesc = []byte{
	...
	0x48, 0x02, 0x08, 0x01, 0x22, 0x9f, 0x01, 0x0a, 0x0a, 0x46, 0x69, 0x6c, 0x65, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x12, 0x4b, 0x0a, 0x05, 0x6b, 0x69, 0x6e, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x63, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x4b,
	0x69, 0x6e, 0x64, 0x42, 0x14, 0xe0, 0x41, 0x01, 0xba, 0x48, 0x0e, 0x92, 0x01, 0x0b, 0x18, 0x01,
	0x22, 0x07, 0x82, 0x01, 0x04, 0x10, 0x01, 0x20, 0x00, 0x52, 0x05, 0x6b, 0x69, 0x6e, 0x64, 0x73,
	0x12, 0x3b, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22,
	...
	0x42, 0x09, 0x0a, 0x07, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0xce, 0x01, 0x0a, 0x11,
	...
	,
	...
	0x72, 0x65, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x05, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x09, 0x42, 0x10, 0xba, 0x48, 0x0d, 0x92, 0x01, 0x0a, 0x08, 0x01, 0x18, 0x01, 0x22,
	0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x05, 0x70, 0x61, 0x74, 0x68, 0x73, 0x22, 0x6b, 0x0a, 0x04,
	0x46, 0x69, 0x6c, 0x65, 0x12, 0x33, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x63, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x4b,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x72, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x65, 0x4f, 0x70, 0x12, 0x41,
	0x0a, 0x0d, 0x61, 0x64, 0x64, 0x5f, 0x6f, 0x72, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x63, 0x65, 0x72, 0x62, 0x6f, 0x73, 0x2e, 0x63,
	0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69,
	0x6c, 0x65, 0x48, 0x00, 0x52, 0x0b, 0x61, 0x64, 0x64, 0x4f, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x70, 0x12, 0x05, 0xba, 0x48, 0x02, 0x08, 0x01, 0x22, 0xb7, 0x02, 0x0a, 0x12, 0x4d, 0x6f, 0x64,
	0x69, 0x66, 0x79, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x23, 0x0a, 0x08, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x08, 0xba, 0x48, 0x05, 0x72, 0x03, 0x98, 0x01, 0x0c, 0x52, 0x07, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x49, 0x64, 0x12, 0x56, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x63, 0x65, 0x72, 0x62, 0x6f, 0x73,
	...
	,
	...
	,
...
var file_cerbos_cloud_store_v1_store_proto_goTypes = []any{
	(FileKind)(0),                        // 0: cerbos.cloud.store.v1.FileKind
	...
	(*ListFilesResponse_File)(nil),       // 12: cerbos.cloud.store.v1.ListFilesResponse.File
	nil,                                  // 13: cerbos.cloud.store.v1.GetFilesResponse.FilesEntry
	(*ModifyFilesRequest_Condition)(nil), // 14: cerbos.cloud.store.v1.ModifyFilesRequest.Condition
}
var file_cerbos_cloud_store_v1_store_proto_depIdxs = []int32{
	...
	0,  // 1: cerbos.cloud.store.v1.FileFilter.kinds:type_name -> cerbos.cloud.store.v1.FileKind
	1,  // 2: cerbos.cloud.store.v1.FileFilter.path:type_name -> cerbos.cloud.store.v1.StringMatch
	2,  // 3: cerbos.cloud.store.v1.ListFilesRequest.filter:type_name -> cerbos.cloud.store.v1.FileFilter
	12, // 4: cerbos.cloud.store.v1.ListFilesResponse.files:type_name -> cerbos.cloud.store.v1.ListFilesResponse.File
	0,  // 5: cerbos.cloud.store.v1.File.kind:type_name -> cerbos.cloud.store.v1.FileKind
	13, // 6: cerbos.cloud.store.v1.GetFilesResponse.files:type_name -> cerbos.cloud.store.v1.GetFilesResponse.FilesEntry
	6,  // 7: cerbos.cloud.store.v1.FileOp.add_or_update:type_name -> cerbos.cloud.store.v1.File
	14, // 8: cerbos.cloud.store.v1.ModifyFilesRequest.condition:type_name -> cerbos.cloud.store.v1.ModifyFilesRequest.Condition
	8,  // 9: cerbos.cloud.store.v1.ModifyFilesRequest.operations:type_name -> cerbos.cloud.store.v1.FileOp
	0,  // 10: cerbos.cloud.store.v1.ListFilesResponse.File.kind:type_name -> cerbos.cloud.store.v1.FileKind
	6,  // 11: cerbos.cloud.store.v1.GetFilesResponse.FilesEntry.value:type_name -> cerbos.cloud.store.v1.File
	3,  // 12: cerbos.cloud.store.v1.CerbosStoreService.ListFiles:input_type -> cerbos.cloud.store.v1.ListFilesRequest
	5,  // 13: cerbos.cloud.store.v1.CerbosStoreService.GetFiles:input_type -> cerbos.cloud.store.v1.GetFilesRequest
	9,  // 14: cerbos.cloud.store.v1.CerbosStoreService.ModifyFiles:input_type -> cerbos.cloud.store.v1.ModifyFilesRequest
	4,  // 15: cerbos.cloud.store.v1.CerbosStoreService.ListFiles:output_type -> cerbos.cloud.store.v1.ListFilesResponse
	7,  // 16: cerbos.cloud.store.v1.CerbosStoreService.GetFiles:output_type -> cerbos.cloud.store.v1.GetFilesResponse
	10, // 17: cerbos.cloud.store.v1.CerbosStoreService.ModifyFiles:output_type -> cerbos.cloud.store.v1.ModifyFilesResponse
