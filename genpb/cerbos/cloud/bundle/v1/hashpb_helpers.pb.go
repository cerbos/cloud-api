...
func cerbos_cloud_bundle_v1_BundleInfo_Segment_hashpb_sum(m *BundleInfo_Segment, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v1_BundleInfo_hashpb_sum(m *BundleInfo, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v1_GetBundleRequest_hashpb_sum(m *GetBundleRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.cloud.bundle.v1.GetBundleRequest.bundle_label"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetBundleLabel()))))
		_, _ = hasher.Write(unsafe.Slice(unsafe.StringData(m.GetBundleLabel()), len(m.GetBundleLabel())))
	}
}

func cerbos_cloud_bundle_v1_GetBundleResponse_hashpb_sum(m *GetBundleResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v1_Manifest_hashpb_sum(m *Manifest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.cloud.bundle.v1.Manifest.meta"]; !ok {
		if m.GetMeta() != nil {
			cerbos_cloud_bundle_v1_Meta_hashpb_sum(m.GetMeta(), hasher, ignore, b)
		}
	}
}

func cerbos_cloud_bundle_v1_Meta_hashpb_sum(m *Meta, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.cloud.bundle.v1.Meta.identifier"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetIdentifier()))))
...
func cerbos_cloud_bundle_v1_WatchBundleRequest_Heartbeat_hashpb_sum(m *WatchBundleRequest_Heartbeat, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v1_WatchBundleRequest_WatchLabel_hashpb_sum(m *WatchBundleRequest_WatchLabel, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v1_WatchBundleRequest_hashpb_sum(m *WatchBundleRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Msg != nil {
		if _, ok := ignore["cerbos.cloud.bundle.v1.WatchBundleRequest.msg"]; !ok {
			...
			case *WatchBundleRequest_WatchLabel_:
				if t.WatchLabel != nil {
					cerbos_cloud_bundle_v1_WatchBundleRequest_WatchLabel_hashpb_sum(t.WatchLabel, hasher, ignore, b)
				}
			case *WatchBundleRequest_Heartbeat_:
				if t.Heartbeat != nil {
					cerbos_cloud_bundle_v1_WatchBundleRequest_Heartbeat_hashpb_sum(t.Heartbeat, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_cloud_bundle_v1_WatchBundleResponse_BundleRemoved_hashpb_sum(m *WatchBundleResponse_BundleRemoved, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
}

func cerbos_cloud_bundle_v1_WatchBundleResponse_Reconnect_hashpb_sum(m *WatchBundleResponse_Reconnect, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v1_WatchBundleResponse_hashpb_sum(m *WatchBundleResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if m.Msg != nil {
		if _, ok := ignore["cerbos.cloud.bundle.v1.WatchBundleResponse.msg"]; !ok {
			...
			case *WatchBundleResponse_BundleUpdate:
				if t.BundleUpdate != nil {
					cerbos_cloud_bundle_v1_BundleInfo_hashpb_sum(t.BundleUpdate, hasher, ignore, b)
				}
			case *WatchBundleResponse_Reconnect_:
				if t.Reconnect != nil {
					cerbos_cloud_bundle_v1_WatchBundleResponse_Reconnect_hashpb_sum(t.Reconnect, hasher, ignore, b)
				}
			case *WatchBundleResponse_BundleRemoved_:
				if t.BundleRemoved != nil {
					cerbos_cloud_bundle_v1_WatchBundleResponse_BundleRemoved_hashpb_sum(t.BundleRemoved, hasher, ignore, b)
				}
			}
		}
	}
