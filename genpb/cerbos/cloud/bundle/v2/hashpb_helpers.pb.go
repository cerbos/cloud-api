...
func cerbos_cloud_bundle_v2_BundleInfo_hashpb_sum(m *BundleInfo, hasher hash.Hash, ignore map[string]struct{}) {
	...
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.input_hash"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(len(m.GetInputHash()))))
		_, _ = hasher.Write(m.GetInputHash())
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.output_hash"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(len(m.GetOutputHash()))))
		_, _ = hasher.Write(m.GetOutputHash())
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.encryption_key"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(len(m.GetEncryptionKey()))))
	...
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.bundle_type"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(nil, uint64(m.GetBundleType())))
	}
}
