...
func cerbos_cloud_bundle_v2_BundleInfo_Segment_hashpb_sum(m *BundleInfo_Segment, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v2_BundleInfo_hashpb_sum(m *BundleInfo, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.source"]; !ok {
		if m.GetSource() != nil {
			cerbos_cloud_bundle_v2_Source_hashpb_sum(m.GetSource(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.input_hash"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetInputHash()))))
		_, _ = hasher.Write(m.GetInputHash())
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.output_hash"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetOutputHash()))))
		_, _ = hasher.Write(m.GetOutputHash())
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.encryption_key"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetEncryptionKey()))))
		_, _ = hasher.Write(m.GetEncryptionKey())
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.segments"]; !ok {
		if len(m.Segments) > 0 {
			for _, v := range m.Segments {
				if v != nil {
					cerbos_cloud_bundle_v2_BundleInfo_Segment_hashpb_sum(v, hasher, ignore, b)
				}
			}
		}
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.BundleInfo.bundle_type"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetBundleType())))
	}
}

func cerbos_cloud_bundle_v2_GetBundleRequest_hashpb_sum(m *GetBundleRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.cloud.bundle.v2.GetBundleRequest.bundle_type"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetBundleType())))
	}
}

func cerbos_cloud_bundle_v2_GetBundleResponse_hashpb_sum(m *GetBundleResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.cloud.bundle.v2.GetBundleResponse.bundle_info"]; !ok {
		if m.GetBundleInfo() != nil {
			cerbos_cloud_bundle_v2_BundleInfo_hashpb_sum(m.GetBundleInfo(), hasher, ignore, b)
		}
	}
}

func cerbos_cloud_bundle_v2_Manifest_hashpb_sum(m *Manifest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.cloud.bundle.v2.Manifest.api_version"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.GetApiVersion()))))
		...
		if len(m.PolicyIndex) > 0 {
			if len(m.PolicyIndex) <= 32 {
				...
				for _, k := range keys {
					...
					_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(len(m.PolicyIndex[k]))))
	...
	if _, ok := ignore["cerbos.cloud.bundle.v2.Manifest.meta"]; !ok {
		if m.GetMeta() != nil {
			cerbos_cloud_bundle_v2_Meta_hashpb_sum(m.GetMeta(), hasher, ignore, b)
		}
	}
}

func cerbos_cloud_bundle_v2_Meta_hashpb_sum(m *Meta, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
...
func cerbos_cloud_bundle_v2_Source_hashpb_sum(m *Source, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if m.Source != nil {
...
func cerbos_cloud_bundle_v2_WatchBundleRequest_Heartbeat_hashpb_sum(m *WatchBundleRequest_Heartbeat, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if _, ok := ignore["cerbos.cloud.bundle.v2.WatchBundleRequest.Heartbeat.bundle_type"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetBundleType())))
	}
}

func cerbos_cloud_bundle_v2_WatchBundleRequest_Start_hashpb_sum(m *WatchBundleRequest_Start, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.cloud.bundle.v2.WatchBundleRequest.Start.source"]; !ok {
		if m.GetSource() != nil {
			cerbos_cloud_bundle_v2_Source_hashpb_sum(m.GetSource(), hasher, ignore, b)
		}
	}
	if _, ok := ignore["cerbos.cloud.bundle.v2.WatchBundleRequest.Start.bundle_type"]; !ok {
		_, _ = hasher.Write(protowire.AppendVarint(b[:0], uint64(m.GetBundleType())))
	}
}

func cerbos_cloud_bundle_v2_WatchBundleRequest_hashpb_sum(m *WatchBundleRequest, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	...
	if m.Msg != nil {
		if _, ok := ignore["cerbos.cloud.bundle.v2.WatchBundleRequest.msg"]; !ok {
			...
			case *WatchBundleRequest_Start_:
				if t.Start != nil {
					cerbos_cloud_bundle_v2_WatchBundleRequest_Start_hashpb_sum(t.Start, hasher, ignore, b)
				}
			case *WatchBundleRequest_Heartbeat_:
				if t.Heartbeat != nil {
					cerbos_cloud_bundle_v2_WatchBundleRequest_Heartbeat_hashpb_sum(t.Heartbeat, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_cloud_bundle_v2_WatchBundleResponse_BundleRemoved_hashpb_sum(m *WatchBundleResponse_BundleRemoved, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
}

func cerbos_cloud_bundle_v2_WatchBundleResponse_Reconnect_hashpb_sum(m *WatchBundleResponse_Reconnect, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if _, ok := ignore["cerbos.cloud.bundle.v2.WatchBundleResponse.Reconnect.backoff"]; !ok {
		if m.GetBackoff() != nil {
			google_protobuf_Duration_hashpb_sum(m.GetBackoff(), hasher, ignore, b)
		}
	}
...
func cerbos_cloud_bundle_v2_WatchBundleResponse_hashpb_sum(m *WatchBundleResponse, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
	if m.Msg != nil {
		if _, ok := ignore["cerbos.cloud.bundle.v2.WatchBundleResponse.msg"]; !ok {
			...
			case *WatchBundleResponse_BundleUpdate:
				if t.BundleUpdate != nil {
					cerbos_cloud_bundle_v2_BundleInfo_hashpb_sum(t.BundleUpdate, hasher, ignore, b)
				}
			case *WatchBundleResponse_Reconnect_:
				if t.Reconnect != nil {
					cerbos_cloud_bundle_v2_WatchBundleResponse_Reconnect_hashpb_sum(t.Reconnect, hasher, ignore, b)
				}
			case *WatchBundleResponse_BundleRemoved_:
				if t.BundleRemoved != nil {
					cerbos_cloud_bundle_v2_WatchBundleResponse_BundleRemoved_hashpb_sum(t.BundleRemoved, hasher, ignore, b)
				}
			}
		}
	}
...
func cerbos_cloud_pdp_v1_Identifier_hashpb_sum(m *v1.Identifier, hasher hash.Hash, ignore map[string]struct{}, b *[10]byte) {
