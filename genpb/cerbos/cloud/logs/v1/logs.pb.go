...
var file_cerbos_cloud_logs_v1_logs_proto_rawDesc = string([]byte{
	...
	0x42, 0x0a, 0xba, 0x48, 0x07, 0x82, 0x01, 0x04, 0x18, 0x01, 0x18, 0x02, 0x52, 0x04, 0x6b, 0x69,
...
func file_cerbos_cloud_logs_v1_logs_proto_rawDescGZIP() []byte {
	file_cerbos_cloud_logs_v1_logs_proto_rawDescOnce.Do(func() {
		file_cerbos_cloud_logs_v1_logs_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_cerbos_cloud_logs_v1_logs_proto_rawDescData)))
	})
	return []byte(file_cerbos_cloud_logs_v1_logs_proto_rawDescData)
}
