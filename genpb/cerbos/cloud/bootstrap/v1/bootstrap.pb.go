...
const file_cerbos_cloud_bootstrap_v1_bootstrap_proto_rawDesc = "" +
	"\n" +
	")cerbos/cloud/bootstrap/v1/bootstrap.proto\x12\x19cerbos.cloud.bootstrap.v1\x1a\x1bbuf/validate/validate.proto\x1a#cerbos/cloud/bundle/v1/bundle.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x94\x02\n" +
	"\tPDPConfig\x12E\n" +
	"\x04meta\x18\x01 \x01(\v2).cerbos.cloud.bootstrap.v1.PDPConfig.MetaB\x06\xbaH\x03\xc8\x01\x01R\x04meta\x12K\n" +
	"\vbundle_info\x18\x02 \x01(\v2\".cerbos.cloud.bundle.v1.BundleInfoB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"bundleInfo\x1as\n" +
	"\x04Meta\x12A\n" +
	"\n" +
...
var (
	...
	file_cerbos_cloud_bootstrap_v1_bootstrap_proto_rawDescData []byte
)
...
func file_cerbos_cloud_bootstrap_v1_bootstrap_proto_rawDescGZIP() []byte {
	file_cerbos_cloud_bootstrap_v1_bootstrap_proto_rawDescOnce.Do(func() {
		file_cerbos_cloud_bootstrap_v1_bootstrap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cerbos_cloud_bootstrap_v1_bootstrap_proto_rawDesc), len(file_cerbos_cloud_bootstrap_v1_bootstrap_proto_rawDesc)))
	})
