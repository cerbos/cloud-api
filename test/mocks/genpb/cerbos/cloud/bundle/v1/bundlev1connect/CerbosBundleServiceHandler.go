...
type mockConstructorTestingTNewCerbosBundleServiceHandler interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCerbosBundleServiceHandler(t mockConstructorTestingTNewCerbosBundleServiceHandler) *CerbosBundleServiceHandler {
